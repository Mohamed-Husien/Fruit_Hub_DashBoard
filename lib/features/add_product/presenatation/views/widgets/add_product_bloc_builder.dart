...
import 'package:fruit_hub_dashboard/core/helper_fun/build_error_bar.dart';
...
import 'package:fruit_hub_dashboard/features/add_product/presenatation/views/widgets/add_product_view_body.dart';

class AddProductBlocBuilder extends StatelessWidget {
  const AddProductBlocBuilder({
    super.key,
  });
